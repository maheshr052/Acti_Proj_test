...
public class SaveMyProfilePage {
	...
	/*Variable Initialization*/
	 ...
	 public boolean verifyRegistrationSuccessfulMsg(){
		 flag = uiDriver.findElement(registrationSuccessfulMsg).isDisplayed();
	 ...
	 public boolean verifyHeaderWelcomeSection(){
		 flag = uiDriver.findElement(headerWelcome).isDisplayed();
	 ...
	 public boolean verifyHeaderLogoutlink(){
		 flag = uiDriver.findElement(headerLogoutLink).isDisplayed();
	 ...
	 public boolean verifyReportAProblemLink(){
		 flag = uiDriver.findElement(reportAProblemLink).isDisplayed();
	 ...
	 public boolean verifyProfileInformationSection(){
		 flag = uiDriver.findElement(profileInformation).isDisplayed();
	 ...
	 public boolean verifyEducationDetailsSection(){
		 flag = uiDriver.findElement(educationDetails).isDisplayed();
	 ...
	 public boolean verifyWorkExperienceSection(){
		 flag = uiDriver.findElement(workExperience).isDisplayed();
	 ...
	 public boolean verifyCurrentPositionSection(){
		 flag = uiDriver.findElement(currentPosition).isDisplayed();
	 ...
	 public boolean verifySaveMyProfileButton(){
		 flag = uiDriver.findElement(saveMyProfileButton).isDisplayed();
	 ...
	 public boolean verifyCurrentIndustryDropdown(){
		 flag = uiDriver.findElement(currentIndustryDropdown).isDisplayed();
	 ...
	 public boolean verifyFunctionalAreaDropdown(){
		 flag = uiDriver.findElement(functionalAreaDropdown).isDisplayed();
	 ...
	 public boolean verifyRoleDropdown(){
		 flag = uiDriver.findElement(roledropdown).isDisplayed();
	 ...
	 public boolean verifyIndustryError(){
		 flag = uiDriver.findElement(industryError).isDisplayed();
	 ...
	 public void verifyIndustryErrorDisplayed(){
		 verifyIndustryError();
		 String indError = uiDriver.findElement(industryError).getText().trim();
	 ...
	 public boolean verifyFunctionalAreaError(){
		 flag = uiDriver.findElement(functionalAreaError).isDisplayed();
	 ...
	 public void verifyFunctionalAreaErrorDisplayed(){
		 ...
		 String funError = uiDriver.findElement(functionalAreaError).getText().trim();
	 ...
	 public boolean verifyRoleError(){
		 flag = uiDriver.findElement(roleError).isDisplayed();
	 ...
	 public void verifyRoleErrorDisplayed(){
		 verifyRoleError();
		 String rolError = uiDriver.findElement(roleError).getText().trim();
	 ...
	 public boolean verifyCompany(){
		 flag = uiDriver.findElement(companyName).isDisplayed();
	 ...
	 public boolean verifySalLacsDD(){
		 flag = uiDriver.findElement(salLacsDD).isDisplayed();
	 ...
	 public boolean verifySalThousandsDD(){
		 flag = uiDriver.findElement(salThousandsDD).isDisplayed();
	 ...
	 public boolean verifySalaryError(){
		 flag = uiDriver.findElement(salError).isDisplayed();
	 ...
	 public void verifySalaryErrorDisplayed(){
		 verifySalaryError();
		 String salaryError = uiDriver.findElement(salError).getText().trim();
	 ...
	 public boolean verifyRupeesRadioButton(){
		 flag = uiDriver.findElement(rupeesRadioButton).isDisplayed();
	 ...
	 public boolean verifyDollorsRadioButton(){
		 flag = uiDriver.findElement(dollorsRadioButton).isDisplayed();
	 ...
	 public boolean verifyFromMonthDD(){
		 flag = uiDriver.findElement(fromMonthDD).isDisplayed();
	 ...
	 public boolean verifyFromYearDD(){
		 flag = uiDriver.findElement(fromYearDD).isDisplayed();
	 ...
	 public boolean verifyToMonthDD(){
		 flag = uiDriver.findElement(toMonthDD).isDisplayed();
	 ...
	 public boolean verifyToYearDD(){
		 flag = uiDriver.findElement(toYearDD).isDisplayed();
	 ...
	 public boolean verifyNoticePeriodDD(){
		 flag = uiDriver.findElement(noticePeriodDD).isDisplayed();
	 ...
	 public boolean verifyJobProfile(){
		 flag = uiDriver.findElement(jobProfile).isDisplayed();
	 ...
	 public boolean verifySpecializationError(){
		 flag = uiDriver.findElement(specializationError).isDisplayed();
	 ...
	 public void verifySpecializationErrorDisplayed(){
		 ...
		 String spError = uiDriver.findElement(specializationError).getText().trim();
	 ...
	 public boolean verifyInstitutionError(){
		 flag = uiDriver.findElement(institutionError).isDisplayed();
	 ...
	 public void verifyInstitutionErrorDisplayed(){
		 ...
		 String instError = uiDriver.findElement(institutionError).getText().trim();
	 ...
	 public boolean verifyYearOfCompletionError(){
		 flag = uiDriver.findElement(yearOfCompletionError).isDisplayed();
	 ...
	 public void verifyYearOfCompletionErrorDisplayed(){
		 ...
		 String yrcError = uiDriver.findElement(yearOfCompletionError).getText().trim();
	 ...
	 public void SelectSpecialization(String spec) throws Exception{
		 ...
		 try{
			 ...
			 //new Select((WebElement) specializationDropdown).selectByVisibleText(spec);
	 ...
	 public void SelectInstitution(String inst) throws Exception{
		 ...
		 try{
			...
			// new Select((WebElement) institutionDropdown).selectByVisibleText(inst);
	 ...
	 public void SelectYearOfCompletion(String ycom) throws Exception{
		 ...
		 try{
			...
			// new Select((WebElement) yearOfCompletionDropdown).selectByVisibleText(ycom);
	 ...
	 public void selectCurrentIndustry(String curInds) throws Exception{
		 ...
		 try{
			...
			// new Select((WebElement) currentIndustryDropdown).selectByVisibleText(curInds);
	 ...
	 public void selectFunctionalArea(String funArea) throws Exception{
		 ...
		 try{
			...
			// new Select((WebElement) functionalAreaDropdown).selectByVisibleText(funArea);
	 ...
	 public void selectRole(String rol) throws Exception{
		 ...
		 try{
			...
			// new Select((WebElement) roledropdown).selectByVisibleText(rol);
	 ...
	 public void selectsalLacs(String salLac) throws Exception{
		 ...
		 try{
			...
			// new Select((WebElement) salLacsDD).selectByVisibleText(salLac);
	 ...
	 public void clickOnSaveMyProfileButton() throws Exception{
		 ...
		 try{
			 ...
			 uiDriver.findElement(saveMyProfileButton).click();
