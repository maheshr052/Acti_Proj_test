...
public class CreateYourJobAlertsPage {
	WebDriver uiDriver;
	...
	public boolean verifyKeySkillsError(){
		flag = uiDriver.findElement(errorKeySkills).isDisplayed();
	...
	public void verifyKeySkillsErrorDisplayed(){
		...
		String skillError = uiDriver.findElement(errorKeySkills).getText().trim();
	...
	public boolean verifyJobAlertNameError(){
		flag = uiDriver.findElement(errorjobAlertName).isDisplayed();
	...
	public void verifyJobAlertNameErrorDisplayed(){
		...
		String jobAlertError = uiDriver.findElement(errorjobAlertName).getText().trim();
	...
	public boolean verifyNameYourJobAlertBox(){
		flag = uiDriver.findElement(nameYourJobAlertBox).isDisplayed();
	...
	public void verifyCreateYourJobAlertsPageTitle() {
		String createYourJobAlertsPageTitle = uiDriver.getTitle().trim();
