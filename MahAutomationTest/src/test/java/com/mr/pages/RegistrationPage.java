...
public class RegistrationPage {
	...
	public void verifyRegistrationPageMessage(){
		String regMessage = uiDriver.findElement(curRegMsg).getText().trim();
	...
	public boolean verifyCreateLoginDetailsSection(){
		flag = uiDriver.findElement(createLoginDetails).isDisplayed();
	...
	public boolean verifyYourContactInformationSection(){
		flag = uiDriver.findElement(yourContactInformationSection).isDisplayed();
	...
	public boolean verifyYourCurrentEmploymentDetailsSection(){
		flag = uiDriver.findElement(yourCurrentEmploymentDetailsSection).isDisplayed();
	...
	public boolean verifyYourEducationBackgroundSection(){
		flag = uiDriver.findElement(yourEducationBackgroundSection).isDisplayed();
	...
	public boolean verifyUploadYourDetailedResumeSection(){
		flag = uiDriver.findElement(uploadYourDetailedResumeSection).isDisplayed();
	...
	public boolean verifyMailerAndPrivacySettingsSection(){
		flag = uiDriver.findElement(mailerAndPrivacySettingsSection).isDisplayed();
	...
	public boolean verifyIAgreeCheckbox(){
		flag = uiDriver.findElement(iAgreeCheckBox).isDisplayed();
	...
	public boolean verifyTermsConditionslink(){
		flag = uiDriver.findElement(termsConditionslnk).isDisplayed();
	...
	public boolean verifyJoinNaukriButton(){
		flag = uiDriver.findElement(joinNaukriButton).isDisplayed();
	...
	public boolean verifyEmailField(){
		flag = uiDriver.findElement(email).isDisplayed();
	...
	public boolean verifyPasswordField(){
		flag = uiDriver.findElement(password).isDisplayed();
	...
	public boolean verifyEmailError(){
		flag = uiDriver.findElement(emailError).isDisplayed();
	...
	public void verifyEmailErrorDisplayed(){
		verifyEmailError();
		String emailErrorDisplayed =uiDriver.findElement(emailError).getText().trim();
	...
	public void verifyPasswordErrorDisplayed(){
		verifyPasswordError();
		String passwordErrorDisplayed =uiDriver.findElement(passwordError).getText().trim();
	...
	public boolean verifyConfirmPassword(){
		flag = uiDriver.findElement(confirmPassword).isDisplayed();
	...
	public boolean verifyErrorAlert(){
		flag = uiDriver.findElement(errorAlert).isDisplayed();
	...
	public boolean verifyAlreadyRegisteredMsg(){
		flag = uiDriver.findElement(alreadyRegisteredMsg).isDisplayed();
	...
	public boolean verifyClose(){
		flag = uiDriver.findElement(close).isDisplayed();
	...
	public boolean verifyPasswordError(){
		flag = uiDriver.findElement(passwordError).isDisplayed();
	...
	public boolean verifyConfirmPasswordError(){
		flag = uiDriver.findElement(confirmPasswordError).isDisplayed();
	...
	public void verifyConfirmPasswordErrorDisplayed(){
		...
		String cPwdError = uiDriver.findElement(confirmPasswordError).getText().trim();
	...
	public boolean verifyFullNameField(){
		flag = uiDriver.findElement(fullName).isDisplayed();
	...
	public boolean verifyCurrentLocationDropdown(){
		flag = uiDriver.findElement(curLocationDropdown).isDisplayed();
	...
	public boolean verifyLocationDropdownError(){
		flag = uiDriver.findElement(locationDDError).isDisplayed();
	...
	public void verifyLocationDDErrorDisplayed(){
		...
		String locError = uiDriver.findElement(locationDDError).getText().trim();
	...
	public boolean verifyMobileNumberField(){
		flag = uiDriver.findElement(mobile).isDisplayed();
	...
	public boolean verifyLandlineLink(){
		flag = uiDriver.findElement(landlineLink).isDisplayed();
	...
	public boolean verifyCountryCode(){
		flag = uiDriver.findElement(countryCode).isDisplayed();
	...
	public boolean verifyAreaCode(){
		flag = uiDriver.findElement(areaCode).isDisplayed();
	...
	public boolean verifyLandLine(){
		flag = uiDriver.findElement(landLine).isDisplayed();
	...
	public boolean verifyMobileNumberError(){
		flag = uiDriver.findElement(mobileError).isDisplayed();
	...
	public void verifyMobileNumberErrorDisplayed(String errorExpectedmobilenumber){
		...
		String mobileErr = uiDriver.findElement(mobileError).getText().trim();
	...
	public boolean verifySkillsError(){
		flag = uiDriver.findElement(skillsError).isDisplayed();
	...
	public void verifySkillsErrorDisplayed(String errorskills){
		verifySkillsError();
		String skillerr = uiDriver.findElement(skillsError).getText().trim();
	...
	public boolean verifyBasicEducationError(){
		flag = uiDriver.findElement(basicEducationError).isDisplayed();
	...
	public void verifyBasicEducationErrorDisplayed(){
		...
		String eduError = uiDriver.findElement(basicEducationError).getText().trim();
	...
	public boolean verifySkillsAutoSuggest(){
		flag = uiDriver.findElement(skillsAutoSuggest).isDisplayed();
	...
	public boolean verifyExperienceError(){
		flag = uiDriver.findElement(experienceError).isDisplayed();
	...
	public void verifyExperienceErrorDisplayed(){
		...
		String expError = uiDriver.findElement(experienceError).getText().trim();
	...
	public boolean verifyBasicEducationDropDown(){
		flag = uiDriver.findElement(basicEducationDropDown).isDisplayed();
	...
	public boolean verifyBrowseButton(){
		flag = uiDriver.findElement(browseButton).isDisplayed();
	...
	public boolean verifyNonSupportedFileError(){
		flag = uiDriver.findElement(nonSupportedFileError).isDisplayed();
	...
	public void verifyNonSupportedFileErrorDisplayed(){
		...
		String fileError = uiDriver.findElement(nonSupportedFileError).getText().trim();
	...
	public boolean verifyPasteResumeLnk(){
		flag = uiDriver.findElement(pasteResumeLnk).isDisplayed();
	...
	public boolean verifyTextArea(){
		flag = uiDriver.findElement(resumetextArea).isDisplayed();
	...
	public boolean verifyJobAlertsCheckBox(){
		flag = uiDriver.findElement(jobAlertsCheckBox).isDisplayed();
	...
	public boolean verifyFastforwardEmailsCheckBox(){
		flag = uiDriver.findElement(fastforwardEmailsCheckBox).isDisplayed();
	...
	public boolean verifyFastforwardSMSCheckBox(){
		flag = uiDriver.findElement(fastforwardSMSCheckBox).isDisplayed();
	...
	public boolean verifyNotificationsCheckBox(){
		flag = uiDriver.findElement(notificationsCheckBox).isDisplayed();
	...
	public boolean verifyCommunicationCheckBox(){
		flag = uiDriver.findElement(communicationCheckBox).isDisplayed();
	...
	public boolean verifyPromoCheckBox(){
		flag = uiDriver.findElement(promoCheckBox).isDisplayed();
	...
	public boolean verifyIAgreeError(){
		flag = uiDriver.findElement(iAgreeError).isDisplayed();
	...
	public void verifyIAgreeErrorDisplayed(){
		verifyIAgreeError();
		String errorIAgree = uiDriver.findElement(iAgreeError).getText().trim();
	...
	public void verifyRegistrationPageTitle(){
		String pageTitle = uiDriver.getTitle().trim();
	...
	public void clickOnJoinNaukriButton() throws Exception{
		...
		uiDriver.findElement(joinNaukriButton).click();
	...
	public void clickOnSkillsField() throws Exception{
		...
		uiDriver.findElement(skillsAutoSuggest).click();
	...
	public void selectExperience(String exp) throws Exception{
		...
		try{
			...
			//new Select((WebElement) experienceDropDown).selectByVisibleText(exp);
	...
	public void selectBasicEducation(String bedu) throws Exception{
		...
		try{
			...
			//new Select((WebElement) basicEducationDropDown).selectByVisibleText(bedu);
